            ...
            <div class="card" style="background: #EBEBEB90">
                ...
                <div class="card-body">
                    <form action="{{route('producto.catalogo')}}" method="get">
                        ...
                        <div class="card my-5" style="width: 20rem; margin:auto">
                ...
                <div class="col-3">
                <div class="card text-black mb-3" style="width: 19rem; margin:auto; margin-top: 20px; background: white; box-shadow: 5px 5px 5px 4px rgba(0, 0, 0, 30%);">
