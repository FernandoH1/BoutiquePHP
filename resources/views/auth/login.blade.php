@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Boutique Anita')])
        ...
        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-primary text-center" style="background: linear-gradient(60deg, #ffde61, #f7ab9f,#ffde61)">
            ...
            <div class="social-line">
                ...
                <img src="{{ asset('/img/boutique.png') }}" alt="HSS" height="100px" width="100px">
             
            </div>
          </div>
          <div class="card-body">
            <!-- <p class="card-description text-center">{{ __('Or Sign in with ') }} <strong>admin@gmail.com</strong> {{ __(' and the password ') }}<strong>secret</strong> </p> -->
            ...
            <div class="bmd-form-group{{ $errors->has('password') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="password" name="password" id="password" class="form-control" placeholder="{{ __('Password...') }}" value="{{ !$errors->has('password') ? "123456789" : "" }}" required>
              </div>
